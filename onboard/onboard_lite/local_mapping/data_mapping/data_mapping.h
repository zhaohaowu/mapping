...
class DataMapping {
 public:
  ...
  static bool CvtMeasurement2Pb(
      const std::shared_ptr<perception_base::MeasurementFrame>& measure_frame,
      std::shared_ptr<hozon::perception::measurement::MeasurementPb> measurepb);
};
