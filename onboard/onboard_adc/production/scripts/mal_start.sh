...
#  compile so
export LD_LIBRARY_PATH=${DEBUG_MAPPING_WORK_ROOT}/runtime_service/mapping/lib:$LD_LIBRARY_PATH
...
export LD_LIBRARY_PATH=${DEBUG_MAPPING_WORK_ROOT}/lib/:$LD_LIBRARY_PATH
...
cd ${DEBUG_MAPPING_WORK_ROOT}/runtime_service/mapping
