...
//------------------------------------------------------------------------------
    ...
    typedef std::vector<DoublePoint> DoublePath;

    inline DoublePath &operator<<(DoublePath &poly, const DoublePoint &p) {
        poly.push_back(p);
        return poly;
    }

    std::ostream &operator<<(std::ostream &s, const DoublePath &p);
//------------------------------------------------------------------------------
    ...
    int PointInPolygon(const DoublePoint &pt, const DoublePath &path);
