...
class LanePostMeasurementFilter : public BaseLaneMeasurementFilter {
 public:
  LanePostMeasurementFilter() : BaseLaneMeasurementFilter() {}
  virtual ~LanePostMeasurementFilter() {}
 ...
 private:
  LanePostMeasurementFilterParam lane_meas_filter_param_;
};
