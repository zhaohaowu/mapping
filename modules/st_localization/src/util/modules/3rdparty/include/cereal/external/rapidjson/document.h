...
#if __GNUC__ >= 6
CEREAL_RAPIDJSON_DIAG_OFF(terminate)  // ignore throwing CEREAL_RAPIDJSON_ASSERT
                                      // in CEREAL_RAPIDJSON_NOEXCEPT functions
#endif
#endif  // __GNUC__
...
class GenericValue {
 public:
    ...
    GenericValue(GenericValue&& rhs) CEREAL_RAPIDJSON_NOEXCEPT
        : data_(rhs.data_) {
 ...
 public:
    ...
    */
    ...
    explicit GenericValue(
        T b, CEREAL_RAPIDJSON_ENABLEIF((internal::IsSame<bool, T>)))
    ...
    explicit GenericValue(int64_t i64) CEREAL_RAPIDJSON_NOEXCEPT : data_() {
        ...
        } else if (i64 >= static_cast<int64_t>(CEREAL_RAPIDJSON_UINT64_C2(
    ...
    ~GenericValue() {
        if (Allocator::kNeedFree) {  // Shortcut by Allocator's trait
            switch (data_.f.flags) {
                ...
                case kObjectFlag:
                    for (MemberIterator m = MemberBegin(); m != MemberEnd();
                         ++m)
                        m->~Member();
    ...
    */
    ...
    GenericValue& CopyFrom(const GenericValue<Encoding, SourceAllocator>& rhs,
                           Allocator& allocator) {
        CEREAL_RAPIDJSON_ASSERT(static_cast<void*>(this) !=
    ...
    */
    ...
    friend inline void swap(GenericValue& a,
                            GenericValue& b) CEREAL_RAPIDJSON_NOEXCEPT {
        a.Swap(b);
    }
    ...
    */
     ...
     */
    template <typename T>
    friend CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>),
                                             (bool))
            ...
            case kObjectType:
                ...
                for (ConstMemberIterator m = MemberBegin(); m != MemberEnd();
                    ...
                    CEREAL_RAPIDJSON_ASSERT(
                        m->name.IsString());  // User may change the type of
 ...
 private:
    ...
    // mode, 13-chars strings for CEREAL_RAPIDJSON_48BITPOINTER_OPTIMIZATION=1
    ...
    union Data {
        ...
        // with CEREAL_RAPIDJSON_48BITPOINTER_OPTIMIZATION
    ...
    CEREAL_RAPIDJSON_FORCEINLINE GenericValue* SetElementsPointer(
        GenericValue* elements) {
        return CEREAL_RAPIDJSON_SETPOINTER(GenericValue, data_.a.elements,
                                           elements);
    }
 ...
 public:
    ...
    */
    ...
    friend inline void swap(GenericDocument& a,
                            GenericDocument& b) CEREAL_RAPIDJSON_NOEXCEPT {
        a.Swap(b);
    }
...
/*!
   ...
   \c CEREAL_RAPIDJSON_HAS_CXX11_RANGE_FOR=1.
*/
