...
#define HLOG_DEBUG NODE_LOG_DEBUG /* NOLINT */
#define HLOG_INFO NODE_LOG_INFO /* NOLINT */
#define HLOG_WARN NODE_LOG_WARN /* NOLINT */
#define HLOG_ERROR NODE_LOG_ERROR /* NOLINT */
#define HLOG_FATAL NODE_LOG_FATAL /* NOLINT */
