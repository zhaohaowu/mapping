...
WheelDataHozon OdometryBase::filter_wheel_data(
    const WheelDataHozon& wheel_data) {
  WheelDataHozon last_data;
  return last_data;
}
...
void OdometryBase::AddOdomData(OdometryData new_odom, double delta_dis) {
  {
