...
#include "modules/map_fusion/modules/lane/lane_predict/lane_prediction.h"
...
#include "modules/map_fusion/modules/lane/road_builder/road_construct.h"
#include "modules/map_fusion/modules/lane/road_topo_builder/topo_construct.h"
#include "modules/map_fusion/modules/lane/virtual_lane_construct/virtual_line_generate.h"
#include "modules/map_fusion/modules/lane_loc/lane_loc.h"
#include "modules/map_fusion/pipelines/base_fusion_pipeline.h"
...
class LaneFusionPipeline : public BaseFusionPipeline {
 ...
 private:
  ...
  VirtualLineGenPtr virtual_line_gen_ = nullptr;
};
