...
#if CEREAL_RAPIDJSON_SCHEMA_USE_INTERNALREGEX || \
    CEREAL_RAPIDJSON_SCHEMA_USE_STDREGEX
...
inline void PrintValidatorPointers(unsigned depth,
                                   const char* s,
                                   const char* d) {
    printf("S: %*s%s\nD: %*s%s\n\n", depth * 4, " ", s, depth * 4, " ", d);
}
...
class Hasher {
 ...
 private:
    ...
    bool WriteBuffer(Type type, const void* data, size_t len) {
        ...
        uint64_t h =
            Hash(CEREAL_RAPIDJSON_UINT64_C2(0x84222325, 0xcbf29ce4), type);
...
#define CEREAL_RAPIDJSON_STRING_(name, ...)                      \
    ...
    CEREAL_RAPIDJSON_STRING_(Dependencies,
                             'd',
                             'e',
                             'p',
                             'e',
    ...
    CEREAL_RAPIDJSON_STRING_(AdditionalProperties,
                             ...
                             'e',
                             's')
    CEREAL_RAPIDJSON_STRING_(MinProperties,
                             'm',
                             'i',
                             'n',
                             'P',
                             ...
                             'e',
                             's')
    CEREAL_RAPIDJSON_STRING_(MaxProperties,
                             'm',
                             'a',
                             'x',
                             'P',
    ...
    CEREAL_RAPIDJSON_STRING_(AdditionalItems,
                             'a',
                             'd',
                             'd',
                             'i',
...
struct TokenHelper {
    CEREAL_RAPIDJSON_FORCEINLINE static void AppendIndexToken(
...
#define CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(method, arg1, arg2) \
    ...
    bool Int64(int64_t i) {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Int64, (CurrentContext(), i),
                                              (i));
    }
    bool Uint64(uint64_t u) {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Uint64, (CurrentContext(), u),
                                              (u));
    }
    bool Double(double d) {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Double, (CurrentContext(), d),
                                              (d));
    }
