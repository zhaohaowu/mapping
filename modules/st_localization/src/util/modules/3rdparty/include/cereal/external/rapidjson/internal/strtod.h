...
inline bool StrtodDiyFp(const char* decimals,
    ...
    for (; i < length; i++) {
        if (significand > CEREAL_RAPIDJSON_UINT64_C2(0x19999999, 0x99999999) ||
            (significand ==
                 CEREAL_RAPIDJSON_UINT64_C2(0x19999999, 0x99999999) &&
             decimals[i] > '5'))
            break;
        significand =
    ...
    if (actualExp != dExp) {
        static const DiyFp kPow10[] = {
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0xa0000000, 00000000),
                  -60),  // 10^1
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0xc8000000, 00000000),
                  -57),  // 10^2
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0xfa000000, 00000000),
                  -54),  // 10^3
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0x9c400000, 00000000),
                  -50),  // 10^4
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0xc3500000, 00000000),
                  -47),  // 10^5
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0xf4240000, 00000000),
                  -44),  // 10^6
            DiyFp(CEREAL_RAPIDJSON_UINT64_C2(0x98968000, 00000000),
                  -40)  // 10^7
        };
