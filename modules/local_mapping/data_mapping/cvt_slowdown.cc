...
// static bool CvtSlowDownToPb(const SlowDownPtr& slowdown_msg,
//                             hozon::perception::SlowDown* pb_object);

// bool DataMapping::CvtMultiSlowDownsToPb(
//     const std::vector<SlowDownPtr>& slowdown_msgs,
...
// bool DataMapping::CvtSlowDownToPb(const SlowDownPtr& slowdown_msg,
...
//     const std::vector<SlowdownPtr>& slowdown_measure,
